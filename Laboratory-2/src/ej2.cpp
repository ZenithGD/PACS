...
int main(int argc, char** argv) {
    ...
    float inicializarTimeIni = inicializarIni.tv_sec * 1e6 + inicializarIni.tv_usec;
    float inicializarTimeFin = inicializarFin.tv_sec * 1e6 + inicializarFin.tv_usec;

    float eigenTimeIni = eigenIni.tv_sec * 1e6 + eigenIni.tv_usec;
    float eigenTimeFin = eigenFin.tv_sec * 1e6 + eigenFin.tv_usec;
    ...
    std::cout << "Tiempo eigen:" <<std::fixed << eigenTimeIni -  eigenTimeFin <<  std::endl;
